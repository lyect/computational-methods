...
double get_trapeze_error_power(const double &a, const double &b, const double &step) {
...
double get_simpson_error_power(const double &a, const double &b, const double &step) {
...
int main() {
	...
	std::cout << "Integration from " << a << " to " << b << " with step = 0.01:\n";

	std::cout << "\tTrapeze: " << TrapezoidalRule(a, b, h1) << "\n";
	std::cout << "\tSimpson: " << SimpsonsRule(a, b, h1) << "\n";

	std::cout << "Integration from " << a << " to " << b << " with step = 0.001:\n";
	...
	std::cout << "Power of the trapezoidal rule error with integration step = 0.1:\n";
	std::cout << "\t" << get_trapeze_error_power(a, b, 1e-1) << "\n";
	std::cout << "Power of the trapezoidal rule error with integration step = 0.01:\n";
	std::cout << "\t" << get_trapeze_error_power(a, b, 1e-2) << "\n";

	// Simpson's rule error
	std::cout << "Power of the Simpson's rule error with integration step = 0.1:\n";
	std::cout << "\t" << get_simpson_error_power(a, b, 1e-1) << "\n";
	std::cout << "Power of the Simpson's rule error with integration step = 0.01:\n";
	std::cout << "\t" << get_simpson_error_power(a, b, 1e-2) << "\n";
